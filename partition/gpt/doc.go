...
//
// gpt.Table implements the Table interface in github.com/herrdivad/go-diskfs/partition
//
// Normally, the best way to interact with a disk is to use the github.com/herrdivad/go-diskfs package,
